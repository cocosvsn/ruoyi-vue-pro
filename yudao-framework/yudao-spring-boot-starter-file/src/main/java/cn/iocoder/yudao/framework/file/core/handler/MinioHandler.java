...
public class MinioHandler implements FileHandler {
    ...
    public MinioHandler(FileProperties fileProperties) {
        Assert.hasText(fileProperties.getMinio().getBucketName(),
                "FileProperties.MinioProperties bucketName must not be empty");
        Assert.hasText(fileProperties.getMinio().getEndpoint(),
                "FileProperties.MinioProperties endpoint must not be empty");
        Assert.hasText(fileProperties.getMinio().getAccessKey(),
                "FileProperties.MinioProperties accessKey must not be empty");
        Assert.hasText(fileProperties.getMinio().getSecretKey(),
                "FileProperties.MinioProperties secretKey must not be empty");
